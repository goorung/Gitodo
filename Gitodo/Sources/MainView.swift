...
class MainView: UIView {
    ...
    let tempIssue = [
        Issue(title: "title", body: nil, assignees: [Assignee(login: "login0", avataUrl: ""), Assignee(login: "login1", avataUrl: ""), Assignee(login: "login2", avataUrl: ""), Assignee(login: "login3", avataUrl: ""), Assignee(login: "login4", avataUrl: ""), Assignee(login: "login5", avataUrl: ""), Assignee(login: "login6", avataUrl: ""), Assignee(login: "login7", avataUrl: ""), Assignee(login: "login8", avataUrl: ""), Assignee(login: "login9", avataUrl: "")], labels: [Label(name: "✨ enhancement", color: "BFD4F2")]),
        Issue(title: "title", body: nil, assignees: [Assignee(login: "login", avataUrl: "")], labels: [Label(name: "🐛 bug", color: "E99695"), Label(name: "🪐 build", color: "D4C5F9"), Label(name: "📋 documentation", color: "C2E0C6"), Label(name: "✨ enhancement", color: "BFD4F2"), Label(name: "🛠️ refactoring", color: "FEF2C0")]),
        Issue(title: "title\ntitle\ntitle", body: nil, assignees: [Assignee(login: "login", avataUrl: "")], labels: [Label(name: "✨ enhancement", color: "BFD4F2")])
    ]
